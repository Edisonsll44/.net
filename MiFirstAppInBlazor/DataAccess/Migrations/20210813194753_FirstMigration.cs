        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WherehouseEntityId = table.Column<string>(type: "nvarchar(50)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Storages_Wherehouses_WherehouseEntityId",
                        column: x => x.WherehouseEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Storages_WherehouseEntityId",
                table: "Storages",
                column: "WherehouseEntityId");
        }
